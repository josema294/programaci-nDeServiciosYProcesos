...
public class Cliente1 {
	...
	public static void main(String[] args) throws UnknownHostException, IOException {
		...
		out.writeUTF(ServerRules.timestamp +  "Hola soy el clietne 1 que te ha colado un mensaje en tu log");
		
		//Lectura de una pieza del log que traemos del servidor
		String piezadeLog = in.readUTF();
		System.out.println("Soy el cliente 1 demostrando que he podido leer una pieza del log del servidor\n" +
		piezadeLog);
